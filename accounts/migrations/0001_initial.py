    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('passenger', 'Passenger'), ('business_partner', 'Business Partner'), ('staff', 'KQ Staff'), ('admin', 'Administrator')], default='passenger', max_length=20)),
